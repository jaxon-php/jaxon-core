...
final class RequestTest extends TestCase
{
    ...
    public function testRequestToJaxonClassWithStringParameter()
    {
        $this->assertEquals(
            ...
            rq('Sample')->method(pm()->string('string'))->raw()
        );
    }
    ...
    public function testRequestToJaxonClassWithIntParameter()
    {
        $this->assertEquals(
            ...
            rq('Sample')->method(pm()->int(2), pm()->numeric(5))->raw()
        );
    }
    ...
    public function testRequestToJaxonClassWithJsParameter()
    {
        $this->assertEquals(
            ...
            rq('Sample')->method(pm()->js('jaxon.val()'), pm()->javascript('jaxon.func()'))->raw()
        );
    }
    ...
    public function testRequestToJaxonClassWithPageParameter()
    {
        $this->assertEquals(
            ...
            rq('Sample')->method(2, 5, pm()->page())->raw()
        );
    }
    ...
    public function testRequestToJaxonClassWithMultipleParameter()
    {
        $this->assertEquals(
            ...
            rq('Sample')->method(pm()->checked('check_id'),
                pm()->select('select_id'), pm()->html('elt_id'))->raw()
        );
    }
    ...
    public function testRequestToJaxonClassWithConfirmationMessageAndSubstitution()
    {
        $this->assertEquals(
            ...
            rq('Sample')->method(pm()->html('elt_id'))
                ...
                ->elseShow("Oh! Sorry M. {1}!", pm()->html('name_id'))->raw()
        );
    }
    ...
    //         rq('Sample')->method()->ifeq(pm()->html('elt_id'), 'yes')->raw()
    //     );
    // }
    ...
    //     $this->assertEquals(
    //         "if(jaxon.$('elt_id').innerHTML==='yes'){JaxonSample.method();}",
    //         rq('Sample')->method()->ifteq(pm()->html('elt_id'), 'yes')->raw()
    //     );
    // }
    ...
    //     $this->assertEquals(
    //         "if(jaxon.$('elt_id').innerHTML!='yes'){JaxonSample.method();}",
    //         rq('Sample')->method()->ifne(pm()->html('elt_id'), 'yes')->raw()
    //     );
    // }
    ...
    //     $this->assertEquals(
    //         "if(jaxon.$('elt_id').innerHTML!=='yes'){JaxonSample.method();}",
    //         rq('Sample')->method()->ifnte(pm()->html('elt_id'), 'yes')->raw()
    //     );
    // }
    ...
    //         rq('Sample')->method()->ifgt(pm()->html('elt_id'), 10)->raw()
    //     );
    // }
    ...
    //     $this->assertEquals(
    //         "if(jaxon.$('elt_id').innerHTML>=10){JaxonSample.method();}",
    //         rq('Sample')->method()->ifge(pm()->html('elt_id'), 10)->raw()
    //     );
    // }
    ...
    //     $this->assertEquals(
    //         "if(jaxon.$('elt_id').innerHTML<10){JaxonSample.method();}",
    //         rq('Sample')->method()->iflt(pm()->html('elt_id'), 10)->raw()
    //     );
    // }
    ...
    //     $this->assertEquals(
    //         "if(jaxon.$('elt_id').innerHTML<=10){JaxonSample.method();}",
    //         rq('Sample')->method()->ifle(pm()->html('elt_id'), 10)->raw()
    //     );
    // }
