...
final class RequestTest extends TestCase
{
    ...
    public function testRequestToGlobalFunctionWithJaxonParameter()
    {
        $this->assertEquals(
            ...
            rq()->func('testFunction', 'string', 2, true, pm()->form('elt_id'), pm()->input('elt_id'))->getScript()
        );
    }
    ...
    public function testRequestToJaxonFunctionWithJaxonParameter()
    {
        $this->assertEquals(
            ...
            rq()->call('testFunction', 'string', 2, true, pm()->form('elt_id'), pm()->input('elt_id'))->getScript()
        );
    }
    ...
    public function testRequestToJaxonClassWithFormParameter()
    {
        $this->assertEquals(
            ...
            rq()->call('Test.method', pm()->form('elt_id'))->getScript()
        );
    }
    ...
    public function testRequestToJaxonClassWithInputParameter()
    {
        $this->assertEquals(
            ...
            rq()->call('Test.method', pm()->input('elt_id'))->getScript()
        );
    }
    ...
    public function testRequestToJaxonClassWithCheckedParameter()
    {
        $this->assertEquals(
            ...
            rq()->call('Test.method', pm()->checked('check_id'))->getScript()
        );
    }
    ...
    public function testRequestToJaxonClassWithSelectParameter()
    {
        $this->assertEquals(
            ...
            rq()->call('Test.method', pm()->select('select_id'))->getScript()
        );
    }
    ...
    public function testRequestToJaxonClassWithInnerHTMLParameter()
    {
        $this->assertEquals(
            ...
            rq()->call('Test.method', pm()->html('elt_id'))->getScript()
        );
    }
    ...
    public function testRequestToJaxonClassWithMultipleParameter()
    {
        $this->assertEquals(
            ...
            rq()->call('Test.method', pm()->checked('check_id'), pm()->select('select_id'), pm()->html('elt_id'))->getScript()
        );
    }
    ...
    public function testRequestToJaxonClassWithConfirmation()
    {
        $this->assertEquals(
            ...
            rq()->call('Test.method', pm()->html('elt_id'))->confirm("Really?")->getScript()
        );
    }
    ...
    public function testRequestToJaxonClassWithConfirmationAndSubstitution()
    {
         $this->assertEquals(
            ...
            rq()->call('Test.method', pm()->html('elt_id'))->confirm("Really M. {1}?", pm()->html('name_id'))->getScript()
        );
    }
    ...
    public function testRequestToJaxonClassWithConditionWhen()
    {
        $this->assertEquals(
            ...
            rq()->call('Test.method', pm()->html('elt_id'))->when(pm()->checked('cond_id'))->getScript()
        );
    }
    ...
    public function testRequestToJaxonClassWithConditionWhenAndMessage()
    {
        $this->assertEquals(
            ...
            rq()->call('Test.method', pm()->html('elt_id'))
