...
use Jaxon\Plugin\Request\CallableFunction\FunctionProxy;
...
final class FunctionTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->xPlugin = jaxon()->di()->getFunctionPlugin();
    }
    ...
    public function testCallableFunctionClass()
    {
        ...
        $this->assertEquals(FunctionProxy::class, get_class($xFirstCallable));
        $this->assertEquals(FunctionProxy::class, get_class($xAliasCallable));
        $this->assertEquals(FunctionProxy::class, get_class($xThirdCallable));
    }
