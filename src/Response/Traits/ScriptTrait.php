...
trait ScriptTrait
{
     ...
     * @return ResponseInterface
     */
    public function setEventHandler(string $sTarget, string $sEvent, JsExpr $xCall): ResponseInterface
    {
     ...
     * @return ResponseInterface
     */
    public function onClick(string $sTarget, JsExpr $xCall): ResponseInterface
    {
     ...
     * @return ResponseInterface
     */
    public function addEventHandler(string $sTarget, string $sEvent, JsExpr $xCall): ResponseInterface
    {
