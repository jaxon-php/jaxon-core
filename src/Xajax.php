...
class Xajax
{
	...
	*/
	...
	/*
		...
		Concat and minify the javascript code generated by Xajax.
	...
	*/
	public function concatJavascript($sJsAppURI, $sJsAppDir, $bMinifyJs = false)
	{
		$this->xPluginManager->concatJavascript($sJsAppURI, $sJsAppDir, $bMinifyJs);
	}
