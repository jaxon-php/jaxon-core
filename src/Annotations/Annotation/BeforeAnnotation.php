...
class BeforeAnnotation extends AbstractAnnotation
{
    ...
    public function initAnnotation(array $properties)
    {
        ...
        {
            throw new AnnotationException('The @before annotation requires a property "name" of type string');
        }
        ...
        if(isset($properties['params']))
        {
            ...
            {
                throw new AnnotationException('The "params" property of the @before annotation must be of type array');
            }
