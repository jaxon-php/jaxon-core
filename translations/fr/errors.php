...
return array(
    ...
    'errors.debug.ts-message' => "** Log d'erreur Xajax - :timestamp ** :message \n",
    ...
    'errors.response.data.invalid' => "La réponse Xajax ne peut traiter les commandes car les données fournies sont invalides.",
    ...
    'errors.uri.detect.advice' => "Vous devriez indiquer l'URI explicitement lorsque vous créez l'objet Xajax.",
    ...
    'errors.register.invalid' => "Tentative d'enregistrer un plugin invalide: :name; " .
        "le plugin doit dériver de Xajax\\Plugin\\Request ou Xajax\\Plugin\\Response.",
    ...
    'errors.output.advice' => "Assurez-vous que la commande \$xajax->processRequest() est placée avant ceci.",
);
